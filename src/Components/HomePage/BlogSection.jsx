    ...
    >
      ...
      <div className="hidden lg:grid grid-cols-2 gap-12">
        <div className="cursor-pointer group bg-[var(--neutral-100)] shadow-md overflow-hidden rounded-2xl">
          ...
          <div className="flex flex-col gap-3 py-6 px-6">
            ...
            <p className="text-[var(--neutral-700)]">
              Occaecat aliquip id duis dolor magna laboris pariatur Lorem ad
              aliquip aliqua ullamco qui.Ipsum aliqua elit veniam id est
              dolore...
            </p>
        ...
        <div className="grid grid-cols-2 gap-6">
          {[1, 2, 3, 4].map((item) => (
            <div
              key={item}
              className="cursor-pointer group bg-[var(--neutral-100)] shadow-md overflow-hidden rounded-xl"
            >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="h-6 w-6 rounded-full bg-[var(--neutral-900)] flex items-center justify-center">
                      <img
                        src={UserIcon}
                        alt="user icon"
                        className="h-2 w-2 object-contain invert"
                      />
                    </div>
                    <span className="text-[var(--secondary-500)]">Admin</span>
                  </div>{" "}
      ...
      <div className="lg:hidden">
        {[1, 2, 3, 4].map((item) => (
          ...
          >
            <img src={Img} alt="" className="h-50 w-full object-cover" />
